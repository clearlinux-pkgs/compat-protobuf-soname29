...
Requires: compat-protobuf-soname29-lib = %{version}-%{release}
Requires: compat-protobuf-soname29-license = %{version}-%{release}
...
%package lib
Summary: lib components for the compat-protobuf-soname29 package.
Group: Libraries
Requires: compat-protobuf-soname29-license = %{version}-%{release}

%description lib
lib components for the compat-protobuf-soname29 package.


%package license
Summary: license components for the compat-protobuf-soname29 package.
Group: Default

%description license
license components for the compat-protobuf-soname29 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663348056
...
export SOURCE_DATE_EPOCH=1663348056
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/compat-protobuf-soname29
cp %{_builddir}/protobuf-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname29/1b5a14d06dd784e88dadc5c68344be2dc13875b6 || :
cp %{_builddir}/protobuf-%{version}/third_party/googletest/googlemock/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname29/5a2314153eadadc69258a9429104cd11804ea304 || :
cp %{_builddir}/protobuf-%{version}/third_party/googletest/googlemock/scripts/generator/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname29/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e || :
cp %{_builddir}/protobuf-%{version}/third_party/googletest/googletest/LICENSE %{buildroot}/usr/share/package-licenses/compat-protobuf-soname29/5a2314153eadadc69258a9429104cd11804ea304 || :
%make_install
## Remove excluded files
rm -f %{buildroot}*/usr/lib/python3.10/site-packages/*
...
rm -f %{buildroot}*/usr/include/google/protobuf/compiler/java/java_kotlin_generator.h
...
rm -f %{buildroot}*/usr/include/google/protobuf/generated_message_tctable_impl.inc
...
rm -f %{buildroot}*/usr/include/google/protobuf/string_member_robber.h
...
/usr/share/package-licenses/compat-protobuf-soname29/1b5a14d06dd784e88dadc5c68344be2dc13875b6
/usr/share/package-licenses/compat-protobuf-soname29/1d4719e04eaa4909ab5a59ef5cb04d2a5517716e
/usr/share/package-licenses/compat-protobuf-soname29/5a2314153eadadc69258a9429104cd11804ea304
